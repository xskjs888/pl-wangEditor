...
window.wangEditor.fullscreen = {
    ...
    init: function(editorSelector){
        $(editorSelector + " .w-e-toolbar").append('<div class="w-e-menu" onclick="window.wangEditor.fullscreen.toggleFullscreen(\'' + editorSelector + '\')"><i class="_wangEditor_btn_fullscreen">全屏</i></div>');
    },
